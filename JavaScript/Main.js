  // Cargar carrito desde LocalStorage o crear uno nuevo
        ...
        function addToCart(name, price) {
            ...
            saveCart(); // Guarda y actualiza la vista
        ...
        // 3. RENDERIZAR PRODUCTOS EN EL MENU
        function renderCart() {
        ...
        // 5. CONFIRMAR Y ENVIAR A WHATSAPP
        function confirmarPedido() {
            ...
            const telefono = "573007350100"; // Asegúrate de incluir el indicativo del país
